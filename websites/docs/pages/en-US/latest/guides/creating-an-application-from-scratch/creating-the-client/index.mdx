...
![Connected](/static/getting-started/guides/creating-an-application-from-scratch/creating-the-client/connected.png)
...
![The chat application](/static/getting-started/guides/creating-an-application-from-scratch/creating-the-client/chat.png)
...
export default ({ children }) => <Documentation>{ children }</Documentation>;
