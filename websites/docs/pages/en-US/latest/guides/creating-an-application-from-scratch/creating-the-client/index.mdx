import { ActivePage, Code, Hint, VersionedLink } from '../../../../../../components';
...
toextend. <VersionedLink rewriteLatestAs='master' href='https://github.com/thenativeweb/wolkenkit-client-template-spa-vanilla-js/archive/#VERSION#.zip'>Download the client</VersionedLink> into
your `chat` directory and, from within this directory, run the following commands:

<ActivePage>
{ ({ version }) => (
  <Code language='shell'>{`
    $ export CLIENT_TEMPLATE="wolkenkit-client-template-spa-vanilla-js-${ version === 'latest' ? 'master' : version }"
...
![Connected](/static/en-US/latest/getting-started/guides/creating-an-application-from-scratch/creating-the-client/connected.png)
...
![The chat application](/static/en-US/latest/getting-started/guides/creating-an-application-from-scratch/creating-the-client/chat.png)
